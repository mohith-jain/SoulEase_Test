...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Sleep Hygine Survey',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      initialRoute: '/', // Set initial route to '/'
      routes: {
        '/sleep': (context) => SleepHygineSurveyPage(), // Define '/' route for AnxietySurveyPage
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Center(
            child: Image.asset('assets/images/sleep.png', height: 200),
          ),
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Welcome to the SleepHygine Quiz!'), // Adjust content as needed
      ),
    );
  }
}